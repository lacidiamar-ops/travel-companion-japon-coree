...
const days = [
  ...
  { id: 3, date: '13 juil.', city: 'Osaka', title: 'Universal Studios Japan', image: '/photo-jour3-usj.jpg', summary: 'Super Nintendo World, Harry Potter, Jurassic Park et Umeda en soirée.', timeRange: '06:30 – 22:00', steps: '20 500 pas', highlights: ['USJ', 'Nintendo', 'Harry Potter'], restaurants: ['USJ snacks', 'Ichiran Shinjuku'], spots: ['Super Nintendo World', 'Hogwarts'] },
  ...
  { id: 8, date: '18 juil.', city: 'Séoul', title: 'Gyeongbokgung → Bukchon → Myeongdong', image: 'https://images.unsplash.com/photo-1517154421773-0529f29ea451?auto=format&fit=crop&w=1200&q=80', summary: 'Palais royal, village hanok, Insadong et street food Myeongdong.', timeRange: '09:00 – 21:30', steps: '14 900 pas', highlights: ['Gyeongbokgung', 'Bukchon', 'Myeongdong'], restaurants: ['Myeongdong Kyoja', 'Insadong Geujib'], spots: ['Bukchon Hanok', 'Myeongdong neon'] },
  ...
  { id: 11, date: '21 juil.', city: 'Busan', title: 'Temple mer → Gamcheon → Gwangalli', image: 'https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&fit=crop&w=1200&q=80', summary: 'Temple Haedong Yonggungsa, Gamcheon, Jagalchi et Gwangalli.', timeRange: '09:00 – 22:00', steps: '16 050 pas', highlights: ['Temple mer', 'Gamcheon', 'Gwangalli'], restaurants: ['Jagalchi', 'BIFF Square'], spots: ['Gamcheon', 'Gwangalli Bridge'] },
...
function BudgetPage() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (cloudConfig?.envelopes) setEnvBudgets(cloudConfig.envelopes)
    ...
    const channel = supabase
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'budget_config' }, () => {
        load()
      })
      .subscribe()
      ...
      <div style={{ display:'flex', background:'#fff', borderRadius:14, padding:4, border:'1px solid #eee', gap:4 }}>
        {[
          ...
          <button key={t.key} onClick={() => setActiveTab(t.key)}
            style={{ flex:1, padding:'8px 4px', borderRadius:10, border:'none', cursor:'pointer', fontSize:'0.75rem', fontWeight:700, fontFamily:'inherit',
            ...
            <div style={{ display:'flex', alignItems:'center', gap:4 }}>
              <input type="number" value={Number(envBudgets['Hébergement'])||0}
                onChange={e => {
                  ...
                  const updated = { ...envBudgets, 'Hébergement': v }
                  setEnvBudgets(updated)
                  saveBudgetConfigToCloud({ envelopes: updated })
                }}
                ...
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:6 }}>
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:4 }}>
                    <input type="number" value={budgetEnv}
                      onChange={e => {
                      const v = Math.max(0, Number(e.target.value)||0)
                      const updated = { ...envBudgets, [env]: v }
                      setEnvBudgets(updated)
                      saveBudgetConfigToCloud({ envelopes: updated })
                    }}
      ...
      <div style={{ display:'flex', gap:6, overflowX:'auto', padding:'4px 0' }}>
        {SUB_TABS.map(t => (
          <button key={t.key} onClick={() => setSubTab(t.key)}
            style={{ flexShrink:0, padding:'7px 14px', borderRadius:20, fontSize:'0.8rem', fontWeight:700, cursor:'pointer', border:'none', whiteSpace:'nowrap', fontFamily:'inherit',
