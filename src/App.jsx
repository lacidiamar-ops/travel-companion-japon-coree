...
const days = [
  ...
  { id: 16, date: '26 juil.', city: 'Tokyo', title: 'Ueno → Yanaka → Akihabara soir', image: 'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?auto=format&fit=crop&w=1200&q=80', summary: 'Parc Ueno et musées, quartier ancien de Yanaka, shopping et soirée Akihabara.', timeRange: '09:00 – 21:30', steps: '14 000 pas', highlights: ['Ueno Park', 'Yanaka', 'Ameya-Yokocho', 'Akihabara'], restaurants: ['Ueno Ippudo', 'Yanaka Ginza street food', 'Akihabara izakaya'], spots: ['Ueno Park', 'Yanaka cemetery', 'Ameya-Yokocho market'] },
